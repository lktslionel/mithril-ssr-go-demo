...
(() => {
      ...
      module.exports = function(render2, schedule, console2) {
        ...
        function sync() {
          ...
          for (var i = 0; i < subscriptions.length; i += 2) {
            try {
              render2(subscriptions[i], Vnode(subscriptions[i + 1]), redraw);
            } catch (e) {
              console2.error(e);
            }
          }
  ...
  var require_mount_redraw2 = __commonJS({
    "node_modules/mithril/mount-redraw.js"(exports, module) {
      ...
      module.exports = require_mount_redraw()(render2, requestAnimationFrame, console);
    }
  });
  ...
  // node_modules/mithril-node-render/index.js
  var require_mithril_node_render = __commonJS({
    "node_modules/mithril-node-render/index.js"(exports, module) {
      "use strict";
      var m2 = require_hyperscript2();
      var Vnode = require_vnode();
      ...
      function* tryRender(view, attrs, options, allowAwait) {
        ...
        function createAttrString(view2) {
          for (const key in view2.attrs) {
            if (hasOwn.call(view2.attrs, key)) {
              let value = view2.attrs[key];
              ...
              if (name === "style" && typeof value === "object") {
                ...
                for (const key2 of Object.keys(styles)) {
                  const prop = styles[key2];
                  if (prop)
                    props.push(`${toStyleKey(key2)}:${prop}`);
                }
                if (!props.length)
                  continue;
                value = props.join(";");
        ...
        function* renderComponent(vnode) {
          ...
          if (vnode.attrs != null)
            yield* setHooks(vnode.attrs, vnode);
          vnode.instance = Vnode.normalize(vnode.state.view(vnode));
          if (vnode.instance != null)
            yield* renderNode(vnode.instance);
        }
  ...
  var import_mithril_node_render = __toESM(require_mithril_node_render());
  function App() {
    const view = import_mithril_node_render.default.sync((0, import_mithril.m)("span", "huhu"));
    console.log(view);
    return view;
  }
  App();
